...
function BuiltBy() {
  return (
    <div className="border-t border-[#181818] py-5">
      <p className="mb-0.5 font-mono text-[9px] uppercase tracking-[0.18em] text-[#282828]">
        Built by
      </p>
      <p className="mb-3 text-[14px] text-[#4a4a4a]">Sean Mullen</p>
      <a
      ...
      <p className="mt-3 font-mono text-[9px] leading-relaxed text-[#252525]">
